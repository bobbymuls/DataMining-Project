...
# redundant variables (columns) are manually deleted from the excel sheet itself
# kslatest.xlsx contains only variables main_category, country, launched_month, backers,
# usd_goal_real, state, duration and textlength
...
fit.glmnet
### 1.0    0.01    0.7921558  5.538964e-01
